(function () {
    ...
    'use strict';
    angular.module('angularFormspree2', []).directive('angularFormspree2', angularFormspree2);
    angularFormspree2.inject = ['$http'];
    function angularFormspree2($http){


	  //1. Add the email you want the messages to be sent to
	  var email = "info@cartix.io";
